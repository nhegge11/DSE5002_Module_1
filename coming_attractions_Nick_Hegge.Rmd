---
title: "Coming_attractions_Nick_Hegge"
author: "Nick Hegge"
date: "2024-07-01"
output: pdf_document
---
...
```{R}
median(Boston_assessment_df$BLDG_VALUE_NUMERIC)
...
```{R}
which.max(Boston_assessment_df$BLDG_VALUE_NUMERIC)
```
...
```{R}
unique(Boston_assessment_df$ST_NAME)
